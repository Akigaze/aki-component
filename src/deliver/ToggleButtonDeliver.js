...
export default class ToggleButtonDeliver extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div>
        <h1 className={titleClassName}>Circle component</h1>
        <Circle size={50} color="#FC7F82" borderColor="#F7595D" circleClick={this.clickCircle}/>
        <br/>
        <h1 className={titleClassName}>CapsuleBox component</h1>
        <span>
        ...
        <br/>
        <h1 className={titleClassName}>ToggleButton components</h1>
